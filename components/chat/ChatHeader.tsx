...
const ChatHeader: React.FC<ChatHeaderProps> = memo(({ isReorderingActive, toggleReordering, onJumpToMessage }) => {
    ...
    return (
        <header className="sticky top-0 z-20 flex items-center justify-between px-4 py-3 bg-[rgba(13,15,24,0.6)] backdrop-blur-md border-b border-white/5 shadow-sm transition-all duration-300">
